...
//    public String generateImage(String prompt, String imgPath) {
...
//	        String b64 = openAiService.createImageVariation(createImageVariationRequest, imgPath).getData().get(0).getB64Json();
	        String b64 = openAiService.createImage(createImageRequest).getData().get(0).getB64Json();
	        return b64;
    	} catch (Exception e) {
            // 이미지 생성 중 에러가 발생하면 예외를 처리합니다.
