    ...
    <div class="container-wrapper">
        <div class="container-white">
            <div class="left text-center" style="width: 40%;">
                <img src="./imgs/40.png" alt="Profile Picture" class="mx-auto" style="width: 60%;">

                <div class="card mb-5">
                    <h3>카드의 정석</h3>
                </div>
                <button class="btn btn-secondary me-3" onclick="location.href='<%= request.getContextPath() %>/design/carddesign'">디자인 수정</button>
