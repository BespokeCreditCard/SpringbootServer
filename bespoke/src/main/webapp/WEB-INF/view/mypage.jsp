    ...
    <div class="container-wrapper">
        <div class="container-white">
            <div class="left text-center" style="width: 40%;">
                <img src="./imgs/40.png" alt="Profile Picture" class="mx-auto" style="width: 45%;">
                ...
                <div class="info">
                    <div class="user-info">
                        <table class="table">
                            ...
                            <tr>
                                <th>이름</th>
                                <td style="font-family: 'WooridaumR';">${userData.name}</td>
                            </tr>
                            <tr>
                                <th>성별</th>
                                <td style="font-family: 'WooridaumR';">
                                    <c:choose>
                            ...
                            <tr>
                                <th>생년월일</th>
                                <td style="font-family: 'WooridaumR';">${userData.birthDate}</td>
                            </tr>
                            <tr>
                                <th>연락처</th>
                                <td style="font-family: 'WooridaumR';">${userData.contact}</td>
                            </tr>
                            <tr>
                                <th>주소</th>
                                <td style="font-family: 'WooridaumR';">${userData.address}</td>
                            </tr>
                        </table>
                    </div>
